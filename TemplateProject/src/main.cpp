...
GLuint LoadShaders(const char * vertex_file_path,const char * fragment_file_path){
    ...
    if(VertexShaderStream.is_open()){
        ...
        spdlog::debug("Impossible to open {}. Are you in the right directory ? Don't forget to read the FAQ !", vertex_file_path);
        getchar();
        return 0;
    }
    ...
    if ( InfoLogLength > 0 ){
        ...
        spdlog::debug("{}", &FragmentShaderErrorMessage[0]);
    }
    ...
    if ( InfoLogLength > 0 ){
        ...
        spdlog::debug("{}", &ProgramErrorMessage[0]);
    }
...
int main()
{
    ...
    spdlog::info("Starting GLFW context, OpenGL 3.3");
    // Init GLFW
    glfwInit();
...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mode)
{
    spdlog::debug("Key pressed like {}", key);
